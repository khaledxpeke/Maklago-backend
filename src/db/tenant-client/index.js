...
const config = {
  ...
  "inlineSchemaHash": "090de2bfc6cdf7e940dff6f67ad0a51327fe5a6dcac780f6678b9abe357fcc86",
  "copyEngine": true
}
...
path.join(process.cwd(), "src/db/tenant-client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/db/tenant-client/schema.prisma")
