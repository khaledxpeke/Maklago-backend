...
import { mobileZonesRouter } from './mobileZones';
...
apiV1Router.use('/activity-logs', activityLogsRouter);
apiV1Router.use('/kitchen/orders', kitchenOrdersRouter);
apiV1Router.use('/mobile/config', mobileConfigRouter);
apiV1Router.use('/mobile/orders', mobileOrdersRouter);
apiV1Router.use('/mobile/zones', mobileZonesRouter);
